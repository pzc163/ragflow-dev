...
async def file_parse(
    ...
    try:
        ...
        if is_json_md_dump:
            ...
            pipe_result.draw_line_sort(os.path.join(output_path, f"{file_name}_line_sort.pdf"))
        ...
        if return_images:
            ...
            data["images"] = {os.path.basename(image_path): f"data:image/jpeg;base64,{encode_image(image_path)}" for image_path in image_paths}
